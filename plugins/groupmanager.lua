...
if matches[1] == "رفعه المدير" and is_sudo(msg) then
...
if matches[1] == "رفعه ادمن" and is_owner(msg) then
   if not matches[2] and msg.reply_to_message then
	if msg.reply.username then
	username = "@"..check_markdown(msg.reply.username)
    else
...
if matches[1] == "رفعه عضو مميز"  and is_mod(msg) then
   if not matches[2] and msg.reply_to_message then
	if msg.reply.username then
	username = "@"..check_markdown(msg.reply.username)
    else
